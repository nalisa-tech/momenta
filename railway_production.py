...
# Only add STATICFILES_DIRS if directory exists
STATICFILES_DIRS = []
events_static = BASE_DIR / 'events' / 'static'
if events_static.exists():
    STATICFILES_DIRS = [events_static]
...
# Email settings (console backend for safety)
